...
const myInternetKEY = `17c3449d-b9b4-492b-8174-dac6d4d1c4c6`
...
returnBack = (id) => {
    ...
    window.open(`информацияПоФильмуИОписание/filmData.html?id=${id}`)
}
drawPagination = (activePage, totalPage) => {
...
serchInp.addEventListener("keydown", function(event) {
    if (event.code == ('Enter')) {
